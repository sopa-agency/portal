  ...
  treasury: {
    ...
    capital: {
      ...
      bridge: {
        ...
        propose: "Propose in the Safe",
        proposing: "Proposing…",
        queued: "Queued on Arbitrum. It needs an owner's signature.",
        ...
        firm: "The swaps.pro route carries an on-chain deadline of about 30 minutes: propose and sign right away, in the same sitting. Past it the execution reverts (GS013) and the proposal has to be rejected. The LayerZero route has no deadline.",
  ...
  treasury: {
    ...
    capital: {
      ...
      bridge: {
        ...
        propose: "Propor no Safe",
        proposing: "Propondo…",
        queued: "Na fila da Arbitrum. Falta a assinatura de um dono.",
        ...
        firm: "A rota do swaps.pro carrega um prazo on-chain de uns 30 minutos: proponha e assine em seguida, na mesma sentada. Passou, a execução reverte (GS013) e a proposta tem de ser rejeitada. A rota LayerZero não tem prazo.",
